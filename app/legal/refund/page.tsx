        ...
        <main className="section" style={{ paddingTop: '8rem', paddingBottom: '4rem' }}>
            <div className="container" style={{ maxWidth: '800px' }}>
                <div className="card" style={{
                    ...
                    <h1 style={{ marginBottom: '1rem', color: '#0f172a', fontSize: '2.5rem' }}>Refund Policy</h1>
                    <p style={{ marginBottom: '2rem', color: '#64748b', fontSize: '0.9rem' }}>Last Updated: December 2024</p>

                    <section style={{ marginBottom: '2rem' }}>
                        <h3 style={{ marginBottom: '1rem', color: '#0f172a', fontSize: '1.25rem' }}>1. General Policy</h3>
                    ...
                    <section style={{ marginBottom: '2rem' }}>
                        <h3 style={{ marginBottom: '1rem', color: '#0f172a', fontSize: '1.25rem' }}>2. Cancellation</h3>
                        <p style={{ color: '#334155', lineHeight: '1.7' }}>
                    ...
                    <section>
                        <h3 style={{ marginBottom: '1rem', color: '#0f172a', fontSize: '1.25rem' }}>3. Dispute Resolution</h3>
                        <p style={{ color: '#334155', lineHeight: '1.7' }}>
