        ...
        <main className="section" style={{ paddingTop: '8rem', paddingBottom: '4rem' }}>
            <div className="container" style={{ maxWidth: '800px' }}>
                <div className="card" style={{
                    ...
                    <h1 style={{ marginBottom: '1rem', color: '#0f172a !important', fontSize: '2.5rem' }}>Terms of Service</h1>
                    <p style={{ marginBottom: '2rem', color: '#64748b !important', fontSize: '0.9rem' }}>Last Updated: December 2024</p>

                    <section style={{ marginBottom: '2rem' }}>
                        <h3 style={{ marginBottom: '1rem', color: '#0f172a !important', fontSize: '1.25rem' }}>1. Agreement to Terms</h3>
                    ...
                    <section style={{ marginBottom: '2rem' }}>
                        <h3 style={{ marginBottom: '1rem', color: '#0f172a !important', fontSize: '1.25rem' }}>2. Intellectual Property Rights</h3>
                        <p style={{ color: '#334155 !important', lineHeight: '1.7' }}>
                    ...
                    <section style={{ marginBottom: '2rem' }}>
                        <h3 style={{ marginBottom: '1rem', color: '#0f172a !important', fontSize: '1.25rem' }}>3. User Representations</h3>
                        <p style={{ color: '#334155 !important', lineHeight: '1.7' }}>
                    ...
                    <section style={{ marginBottom: '2rem' }}>
                        <h3 style={{ marginBottom: '1rem', color: '#0f172a !important', fontSize: '1.25rem' }}>4. Limitations of Liability</h3>
                        <p style={{ color: '#334155 !important', lineHeight: '1.7' }}>
                    ...
                    <section style={{ marginBottom: '2rem' }}>
                        <h3 style={{ marginBottom: '1rem', color: '#0f172a !important', fontSize: '1.25rem' }}>5. Governing Law</h3>
                        <p style={{ color: '#334155 !important', lineHeight: '1.7' }}>
